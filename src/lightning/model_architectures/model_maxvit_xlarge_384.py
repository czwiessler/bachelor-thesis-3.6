...
class MaxVitTimmModel(pl.LightningModule):
    def __init__(self, model_name='timm/maxvit_xlarge_tf_384.in21k_ft_in1k', num_classes=8, learning_rate=3.9810717055349735e-05):
        super().__init__()
