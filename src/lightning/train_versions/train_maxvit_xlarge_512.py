...
from src.lightning.model_architectures.model_maxvit_xlarge_512 import MaxVitTimmModel
...
def init_trainer(model, use_lr_finder):
    ...
    checkpoint_callback = pl.callbacks.ModelCheckpoint(
        ...
        monitor='val_loss',
        mode='min',
        filename='maxVitXlarge512-{epoch}-{val_loss:.5f}'
    )


    trainer = pl.Trainer(max_epochs=20, log_every_n_steps=1, callbacks=[checkpoint_callback])
