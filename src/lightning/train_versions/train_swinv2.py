...
from src.lightning.model_architectures.model_swinv2 import Swinv2TimmModel
...
def init_trainer(model, use_lr_finder):
    ...
    checkpoint_callback = pl.callbacks.ModelCheckpoint(
        ...
        monitor='val_loss',
        mode='min',
        filename='swinV2-{epoch}-{val_loss:.5f}'
    )
...
model_instance = Swinv2TimmModel(learning_rate=3.9810717055349735e-05)
