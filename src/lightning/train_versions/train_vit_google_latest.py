...
from src.lightning.model_architectures.model_vit_google_latest import VitGoogleLatestTimmModel
...
def init_trainer(model, use_lr_finder):
    ...
    checkpoint_callback = pl.callbacks.ModelCheckpoint(
        ...
        monitor='val_loss',
        mode='min',
        filename='vitGoogleLatest-{epoch}-{val_loss:.5f}'
    )
...
model_instance = VitGoogleLatestTimmModel(learning_rate=8.317637711026709e-05)
